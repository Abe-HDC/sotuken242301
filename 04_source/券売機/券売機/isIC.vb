...
Public Class isIC
    ...
    Private Sub ch1000_Click(sender As Object, e As EventArgs) Handles ch1000.Click
        ...
        Command.CommandText = $"UPDATE iccard SET bal = {ch} WHERE ICno = {ReceivedId}"
        'SQLを実行
    ...
    Private Sub isIC_Load(sender As Object, e As EventArgs) Handles Me.Load
        ' 画面の作業領域（タスクバーを除く）
