...
Public Class passcopay
    ...
    Private Sub passcopay_Load(sender As Object, e As EventArgs) Handles Me.Load
        '変数の宣言
        ...
        Command.CommandText = $"Select Case name,seinen,stday,endday,depass,arpass,month FROM iccard WHERE ICno = {ReceivedId}"
        'SQLを実行
